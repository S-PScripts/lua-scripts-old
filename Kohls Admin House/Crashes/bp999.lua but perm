-- buggy shit i'll fix it later
-- original by tech-187
...
getgenv().gearwhitelisted = {"ScriptingProgrammer","Master0fSouIs","ScaleneSoap9803","t_echr","Humangas","ovicaI","Ba_lIon","naomicaesar","jjjuuikjjikkju","SoaringLys","Di33le2"} -- Players that are in this table won't get ungeared by default.
...
if shared.gpcheck == true then
    if string.match(game:HttpGet("https://inventory.roblox.com/v1/users/" .. userId .. "/items/GamePass/" .. passid), passid) then
        ...
        print("Person299 pass not found. Booting anyways.")
        return
    end
end
