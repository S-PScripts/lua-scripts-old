...
for i, player in pairs(game.Players:GetPlayers()) do
    if table.find(crashwl, player.Name) then
        game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("{Kohls+ Crasher} Whitelisted user(s) in server! Skipping. RN: ".. math.random(1,1000), "All")
        ...
        game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Kohls+ Crasher Executed! RN: ".. math.random(1,1000), "All")
